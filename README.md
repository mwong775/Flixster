...
<img src="https://i.imgur.com/Bu7MzZv.gif" width=250><br>

### Notes

- YouTube API only works for certain Android Platform APIs (e.g. API 27) and not others (e.g. APIs 24 and 30). Incompatible APIs are unable to play the video and deliver a 400 response error.
